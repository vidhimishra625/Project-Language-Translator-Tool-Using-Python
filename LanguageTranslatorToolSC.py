...
#heading
Label(root, text = "LANGUAGE TRANSLATOR", font = "arial 20 bold",bg='cyan').pack()
...
##########  Translate Button #########
trans_btn = Button(root, text = 'Translate',font = 'arial 12 bold',pady = 5,command = Translate , bg = 'royal blue', activebackground = 'sky blue')
